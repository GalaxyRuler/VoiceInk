...
public sealed class DiagnosticEventSanitizerTests
{
    ...
    [InlineData("Enhancement enabled", "Enhancement enabled")]
    [InlineData("Enhancement disabled", "Enhancement disabled")]
    [InlineData("Enhancement toggle failed: C:\\Users\\Admin\\settings.json", "Enhancement toggle failed")]
