...
Write-Host '  .\VoiceInk.Windows\scripts\package-msix.ps1 -DotNetPath "..\.dotnet-sdk-10\dotnet.exe" -PackageCertificateKeyFile <maintainer-owned.pfx> -TimestampServerUrl "http://timestamp.acs.microsoft.com" -TimestampDigestAlgorithm SHA256 -ValidateAfterBuild'
Write-Host '  .\VoiceInk.Windows\scripts\package-msix.ps1 -ValidateAfterBuild -PackageCertificateKeyFile <maintainer-owned.pfx> -TimestampServerUrl "http://timestamp.acs.microsoft.com" -TimestampDigestAlgorithm SHA256'
...
Write-Host "  [ ] Timestamp signed packages with a trusted timestamp authority so the package remains verifiable after certificate expiry; package-msix.ps1 defaults TimestampServerUrl to http://timestamp.acs.microsoft.com and TimestampDigestAlgorithm to SHA256."
