...
public sealed class CartesiaLiveTranscriptionPreviewService(
    ...
    TimeSpan? cleanupTimeout = null) : ILiveTranscriptionPreviewService
{
        ...
        CancellationToken cancellationToken)
    {
        if (!settings.ShowLiveTranscriptPreview
            ...
            || !string.Equals(
                ...
                TranscriptionProviderPresetCatalog.Cartesia.Id,
        ...
        try
        {
            await ConnectWithTimeoutAsync(
                    socket,
                    CartesiaStreamingUriFactory.Build(settings),
        ...
        return new CartesiaLiveTranscriptionPreviewSession(socket, partialTranscriptUpdated, cleanupTimeout);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new TimeoutException("Cartesia live transcript preview connection timed out.");
        }
    }
    ...
    private sealed class CartesiaLiveTranscriptionPreviewSession : ILiveTranscriptionPreviewSession
    {
        ...
        public CartesiaLiveTranscriptionPreviewSession(
            IStreamingWebSocket socket,
            Action<string> partialTranscriptUpdated,
        ...
        public async Task CompleteAsync(CancellationToken cancellationToken)
        {
            ...
            if (sendCompleted)
            {
                await SendTextNoThrowAsync("finalize", cancellationToken).ConfigureAwait(false);
                await SendTextNoThrowAsync("close", cancellationToken).ConfigureAwait(false);
        ...
        private async Task ReceiveLoopAsync()
        {
            ...
            try
            {
                ...
                {
                    var transcript = CartesiaStreamingMessageParser.Parse(message);
