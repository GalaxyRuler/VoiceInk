...
public sealed class SqliteHistoryStore : IHistoryStore
{
    ...
    public async Task SaveAsync(TranscriptionHistoryItem item, CancellationToken cancellationToken)
    {
        ...
        command.Parameters.AddWithValue("$enhancement_provider_name", ValueOrDbNull(item.EnhancementProviderName));
    ...
    private void EnsureDatabase()
    {
        ...
        EnsureColumn(connection, "enhancement_provider_name", "enhancement_provider_name TEXT NULL");
