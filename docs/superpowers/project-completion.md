...
```text
Windows Onboarding setup actions  [####################] 100%
```

Completed:

- Added Core onboarding setup action rows for model, microphone, shortcut, and first dictation.
- Rendered the action rows inside the first-run setup dialog.
