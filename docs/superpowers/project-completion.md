...
```text
Windows Power Mode match guidance  [####################] 100%
```

Completed:

- Wrote the Power Mode match guidance spec and implementation plan.
- Added a failing Power Mode presenter assertion for page-level rule precedence guidance.
- Added `MatchGuidance` to `PowerModePagePresenter` and rendered it in the WinUI Power Mode page.
