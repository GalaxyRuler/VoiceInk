...
```text
Windows History waveform visualization  [####################] 100%
```

Completed:

- Added dependency-free PCM16 WAV peak extraction in Core.
- Added waveform bars to the inline History audio player.
- Added waveform bars to the dedicated History window audio player.
- Hid waveform controls gracefully for unsupported or unreadable audio files.

## Near-Term Priority

1. Expand streaming/live preview beyond Deepgram and continue recorder waveform visual polish.
2. Continue Settings visual parity and remaining macOS preferences.
3. Continue packaging from MSIX foundation to signed smoke, uninstall behavior, and release signing flow.
4. Add History performance analysis overlays if still desired after core parity work.
