...
```text
Windows model health guidance  [####################] 100%
```

Completed:

- Wrote the model health guidance spec and implementation plan.
- Added failing ready/broken model health presenter tests.
- Added selected-model health guidance rows to the Core presenter and WinUI model page.
