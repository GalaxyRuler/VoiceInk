...
```text
Windows settings diagnostics guidance  [####################] 100%
```

Completed:

- Wrote the settings diagnostics guidance spec and implementation plan.
- Added failing Settings presenter assertions for diagnostics guidance rows.
- Added diagnostics guidance rows to the Core presenter and About/Diagnostics UI.
