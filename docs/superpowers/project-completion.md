...
```text
Windows context action guidance  [####################] 100%
```

Completed:

- Wrote the context action guidance spec and implementation plan.
- Added failing presenter tests for context action rows.
- Added Core presenter action rows for Enhancement, Clipboard Context, Screen OCR setup/readiness, and source order.
- Rendered the action rows in the Enhancement page.
