# Windows Dictionary Usage Summary Implementation Plan
...
**Goal:** Add scan-friendly dictionary usage summary rows.

**Architecture:** Extend the Core dictionary presentation and bind the WinUI Dictionary page to the new rows.

**Tech Stack:** .NET 10, C#, WinUI 3, xUnit.

---

### Task 1: Core Summary Rows
...
- [x] **Step 1: Add dictionary summary list**
- [x] **Step 2: Bind presenter summary rows**
