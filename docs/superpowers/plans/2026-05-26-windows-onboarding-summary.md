# Windows Onboarding Summary Implementation Plan
...
**Goal:** Add compact readiness summary rows to first-run setup.

**Architecture:** Keep setup state in Core presenter data and bind the existing WinUI onboarding dialog to the new rows.

**Tech Stack:** .NET 10, C#, WinUI 3, xUnit.

---

### Task 1: Presenter Summary Rows
...
### Task 2: WinUI Dialog Binding

**Files:**
- Modify: `VoiceInk.Windows/src/VoiceInk.Windows.App/MainWindow.xaml.cs`

- [x] **Step 1: Add summary list to onboarding dialog**
- [x] **Step 2: Refresh summary rows when setup fields change**
