...
**Goal:** Replace the single long Windows control surface with a macOS-aligned WinUI navigation shell that groups existing features into Dashboard, History, AI Models, Audio Input, Dictionary, Settings, and About/Open Source sections.
...
- Active Windows sections for this slice: Dashboard, History, AI Models, Audio Input, Dictionary, Settings, About/Open Source.
...
- [x] **Step 1: Add navigation presenter tests**
...
- [x] **Step 1: Replace root scroll with NavigationView**
...
- [x] **Step 2: Add section navigation code**
...
Generate `NavigationViewItem` entries from `ShellNavigationPresenter.BuildItems()` in code-behind so Core remains the single source of truth for tag, label, icon, enabled state, and order.

- [x] **Step 3: Route existing History command through navigation**
...
- [x] **Step 4: Add About/Open Source actions**
...
- Existing controls are grouped into Dashboard, History, AI Models, Audio Input, Dictionary, and Settings.
