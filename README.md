...
- Default-off AI Enhancement section with OpenAI-compatible endpoint/model settings, prompt selection, timeout/short-phrase/retry settings, Windows Credential Manager API key storage, output filtering, and original-text fallback
