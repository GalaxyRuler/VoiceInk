...
- Expanded history metadata for original text, final text, enhanced text, status, language, model path, prompt name, enhancement provider/model, enhancement timing, AI request messages, and audio file path
