...
`test-release-readiness.ps1` only verifies that the release packaging scripts/assets are present and prints the ordered packaging commands; it does not run publish, signing, install, uninstall, launch, or certificate-store operations.
