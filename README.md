...
- Local Whisper catalog cards with direct GGML `.bin` downloads, app-local model storage, imported `.bin` references, and default model selection from the shell
