...
- Compact always-on-top floating mini-recorder during recording and processing, with state text, elapsed timer, live microphone level bars, non-activating Stop/Cancel controls, hover-dismissable no-activate Prompt/Power chooser panels, a gated live transcript preview panel for real partial sources, and pulse animation
