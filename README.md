...
- Compact always-on-top floating mini-recorder during recording and processing, with state text, elapsed timer, live microphone level bars, non-activating Stop/Cancel controls, pulse animation, and Prompt/Power affordance labels
