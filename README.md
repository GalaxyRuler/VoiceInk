...
- Default-off OpenAI-compatible cloud transcription provider with endpoint/model settings, Windows Credential Manager API key storage, multipart file/model/language/prompt requests, sanitized HTTP errors, and routing across Dictation, Transcribe Audio, and History Retry
