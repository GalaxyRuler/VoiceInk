...
Primary and secondary recording shortcuts each support Toggle, Push to Talk, and Hybrid modes. Windows uses a low-level key-up hook only for recording shortcuts and keeps utility shortcuts on `RegisterHotKey`.
...
- Configurable global key+modifier shortcuts for primary and secondary recording with Toggle, Push to Talk, and Hybrid modes, plus paste last, paste last enhanced, retry last transcription, cancel recording, open history, and quick add to dictionary
