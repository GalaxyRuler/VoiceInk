...
- Default-off OpenAI-compatible cloud transcription provider with custom, Groq, and Deepgram presets, endpoint/model settings, provider-specific Windows Credential Manager API key storage, multipart OpenAI-compatible requests, direct Deepgram batch requests with advanced endpoint query options, Deepgram live recorder preview streaming, sanitized HTTP errors, and routing across Dictation, Transcribe Audio, and History Retry
