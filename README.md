...
- Local Whisper catalog cards with direct GGML `.bin` downloads, app-local model storage, imported `.bin` references, selected model path health checks, model-aware transcription language selection, nonblocking warmup/preload, and default model selection from the shell
