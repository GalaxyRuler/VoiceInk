...
- Local Whisper catalog cards with direct GGML `.bin` downloads, app-local model storage, imported `.bin` references, model-aware transcription language selection, and default model selection from the shell
