...
`test-msix-package.ps1` only inspects the artifact under `VoiceInk.Windows\artifacts`; it does not install, uninstall, launch, sign, create certificates, import certificates, or cryptographically verify the package signature.
