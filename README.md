...
- Transcribe Audio section with multi-file picker and drag-and-drop import, in-memory pending/processing/completed/failed queue, cancel/clear/remove/retry controls, Media Foundation import to app-owned WAV recordings, selected-provider transcription, cleanup, and History save
